  ...
  return (
    <div className="animate-fade-in-up">
      ...
      <p className="text-center text-lg text-gray-500 dark:text-gray-400 mb-12 max-w-3xl mx-auto">
        Both traditional and modern medicine offer valuable approaches to health. Understanding their core differences helps appreciate the unique strengths of each system.
      </p>
      ...
      <div className="mt-16 bg-indigo-50 dark:bg-indigo-900/20 p-8 rounded-2xl max-w-5xl mx-auto border border-indigo-200 dark:border-indigo-800">
